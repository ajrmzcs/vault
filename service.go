...
func (v vaultService) Hash(ctx context.Context, password string) (string, error) {
...
func (v vaultService) Validate(crx context.Context, password string, hash string) (bool, error) {
